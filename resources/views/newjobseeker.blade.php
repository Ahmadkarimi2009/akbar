...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <form class="form-signin mt-5"  method="POST" action="{{route('jobseeker.store')}}" enctype="multipart/form-data">
                    ...
                    <fieldset class="fieldsets p-3 rounded">
                        <legend class="w-auto pl-3 pr-3"><h5>Job Seeker Registration</h5></legend>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group-icon">
                                    <label>First Name <span class="float-right">*</span></label>
                                    <input type="text" name="name" placeholder="eg. Dawood"   required="" class="form-control mr-2" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group-icon mt-3">
                                    ...
                                    <input type="text" name="lastname" placeholder="eg. Mohammadi"   required="" class="form-control mr-2" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-group-icon mt-3">
                                    ...
                                    <input type="email" name="email" placeholder="eg. dawood.mohammadi@gmail.com"   required="" class="form-control mr-2" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group-icon mt-3">
                                    ...
                                    <input type="file" name="file" id="passwordreenterfield"   required="" class="form-control mr-2" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="button-group-area mt-40">
                            <button type="submit" class="btn btn-lg btn-block btn-success radius mt-3" id="submitbtn">Register</button>
                        </div>
                        <a class="text-center d-block mt-3 text-info" href="{{route('company.create')}}">Sign up as a company</a>
                    </fieldset>
                </form>
